...
<AccordionGroup>
  ...
  <Accordion title="One bundle, five products">
    Most teams stitch together Sanity + Buffer + Cal.com + Shopify + a hand-rolled
    Stripe Connect. We ship all five behind one API key, on one bill, with one
    brand object that flows through every output. Switching costs are real;
    bundles win.
  </Accordion>
