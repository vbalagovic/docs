...
Premium short-form clip (Kling v2.1 / Runway Gen4). Returns a Job; poll
`get_job` until complete. Charges 100 credits per call.
...
npm package. File issues against the
[SDK repo](https://github.com/vbalagovic/neuraldraft-sdk/issues) for now —
they share the same maintainer, and most MCP bugs trace back to client-shape
mismatches. We follow SemVer; non-breaking additions are normal.
