...
those environments, we ship a **system-prompt block** ([snippets/lovable](/snippets/lovable))
...
<CardGroup cols={2}>
  ...
  <Card title="Lovable / v0 / Bolt" icon="sparkles" href="/snippets/lovable">
    The system-prompt block that gives non-MCP clients the same conventions.
  </Card>
  <Card title="Cursor template" icon="code" href="/snippets/cursor">
