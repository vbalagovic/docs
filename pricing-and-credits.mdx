...
1,000 credits/month covers, for example:

- 66 chat messages, **or**
- 2 blog posts + a few chats, **or**
- 25 single-platform social posts, **or**
- 1 image + 10 page edits + 20 chats.

Tight enough that real product usage forces an upgrade — generous enough to
build, test and demo a working integration end to end.
...
We anchor every credit cost to **≥ 75% gross margin at the Scale tier on
every operation**. That math is published at signup. Cost-to-serve drifts as
upstream model prices change; we re-anchor every 90 days, and any operation
that drops below 75% margin at Scale triggers a credit-cost bump with 30 days'
notice.

What that means for you:

- Pricing won't drop because we love you. It might drop because OpenAI or
  Anthropic dropped their list price. Same direction, smaller magnitude.
- Pricing won't spike because of a quarter-end revenue panic. The 75% floor is
  a published rule; we're audited against it.
